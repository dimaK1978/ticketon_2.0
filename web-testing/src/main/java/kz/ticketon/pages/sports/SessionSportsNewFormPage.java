...
public class SessionSportsNewFormPage extends SessionPage {
    ...
    public SessionSportsNewFormPage(String titleExpect, String time, String day, String month, String movieTheatre) {
