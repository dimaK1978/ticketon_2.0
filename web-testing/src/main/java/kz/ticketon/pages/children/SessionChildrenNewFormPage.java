...
public class SessionChildrenNewFormPage extends SessionPage {
    ...
    public SessionChildrenNewFormPage(String titleExpect, String time, String day, String month, String movieTheatre) {
